                                ...
                                <div class="column" style="text-align: left;color: #8f8f8f;font-size: 16px;line-height: 24px;font-family: Open Sans,sans-serif;">
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;">
                                        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                            <h1 style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #404040;font-size: 28px;line-height: 36px;text-align: center;">Bedankt voor je aanmelding!</h1>
                                        </div>
                                    </div>
