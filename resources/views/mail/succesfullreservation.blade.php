...
<body class="full-padding" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;">
    <!--<![endif]-->
    <table class="wrapper"
           style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #919e93;"
                ...
                <td>
                    <div role="banner">
                        <div class="preheader"
                            ...
                            <div style="border-collapse: collapse;display: table;width: 100%;">
                                ...
                                <div class="snippet"
                                     style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 140px; width: 140px;width: calc(14000% - 78120px);padding: 10px 0 5px 0;color: #bdb9bd;font-family: Cabin,Avenir,sans-serif;">

                                </div>
                                <!--[if (mso)|(IE)]></td>
                                <td style="width: 280px" valign="top"><![endif]-->
                                <div class="webversion"
                                     style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 139px; width: 139px;width: calc(14100% - 78680px);padding: 10px 0 5px 0;text-align: right;color: #bdb9bd;font-family: Cabin,Avenir,sans-serif;">
                        ...
                        <div class="header"
                            ...
                            <div class="logo emb-logo-margin-box"
                                ...
                                <div class="logo-center" align="center" id="emb-email-header">
                                    <img style="display: block;height: auto;width: 100%;border: 0;max-width: 136px;"
                                         src="https://i1.createsend1.com/ei/t/29/8F0/59C/073612/csfinal/werkplaats75c.png"
                                         alt="" width="136">
                                </div>
                            </div>
                            <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
                    ...
                    <div>
                        <div class="layout one-col fixed-width stack"
                             style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;      box-shadow: 0 3px 6px rgba(0, 0, 0, 0.35);">
                            <div class="layout__inner"
                                ...
                                <div class="column"
                                     style="text-align: left;color: #8f8f8f;font-size: 16px;line-height: 24px;font-family: Open Sans,sans-serif;">
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;">
                                        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                            <h1 style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #404040;font-size: 28px;line-height: 36px;text-align: center;">
                                                Bedankt voor je reservering!</h1>
                                        </div>
                                    </div>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;Margin-bottom: 20px;"
                                             align="center">
                                            @if(strtolower($ruimte) === strtolower('SPREEKKAMER'))
                                                <img style="border: 0;display: block;height: auto;width: 100%;max-width: 900px;"
                                                     alt="" width="560" src="{{asset('storage/img/spreekkamer.png')}}">
                                            @else
                                                <img style="border: 0;display: block;height: auto;width: 100%;max-width: 900px;"
                                                     alt="" width="560" src="{{asset('storage/img/workshop.jpeg')}}">
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                            ...
                                            <p style="Margin-top: 20px;Margin-bottom: 0;">Hartelijke groeten,</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;">Karin en Renate</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 20px;">Werkplaats 75C</p>
                                        </div>
                                    </div>
